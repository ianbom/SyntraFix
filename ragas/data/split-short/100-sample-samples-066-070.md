...
The software engineering research will be defined by a more intensive interest in the meta-engineering problems, which include designing processes and systems that can guarantee successful collaboration of the agents and humans in the software creation, maintenance and evolution areas.

The synthesis was aimed at determining patterns in software engineering methods of agency and comparing methods and outcomes between the studies and deriving insights regarding the present state and future of the field.

Although not explicitly studying SSCs, different researchers have expressed concern over the gaps in the literature on software development practice.
...
• Purpose -Systematic literature review. • Objective -Peer-reviewed research papers in computer science and software engineering. • Issue -Taxonomies for evaluating the quality of intelligent software systems. • Viewpoint -Software engineers and industry practitioners.

This paper presents a systematic review of the current state of the taxonomy of quality assessment for AI-based software. The main goal of this work is to study the field's landscape and consolidate knowledge to help researchers identify further areas of research.

By implementing a structured and objective quality assessment process, this systematic literature review aims TABLE 2. Questions -quality assessment. to provide a comprehensive and reliable synthesis of the most relevant and high-quality publications in the field.

A comprehensive literature review is imperative to identify and analyze recent advances and contributions to GAI in SD. To facilitate a systematic and rigorous examination, it is essential to implement well-defined review protocols and structured methodologies.

Nowadays, a company's ability to innovate is increasingly driven by software. Digital technologies play a key role in The associate editor coordinating the review of this manuscript and approving it for publication was Waldemar W.
...
Agile development methodologies are widely adopted nowadays by software development companies of every kind [37]. Industry surveys show that virtually all organisations use Agile methods to some extent, and over half of them have Agile as their usual approach to software development.

A comprehensive literature review is imperative to identify and analyze recent advances and contributions to GAI in SD. To facilitate a systematic and rigorous examination, it is essential to implement well-defined review protocols and structured methodologies.

To present a comprehensive picture of quality for AI-based software, we conducted a systematic literature analysis following the approach by Kitchenham [14]. Systematic literature studies in software engineering can include reviews and syntheses of prior work, enabling researchers to gain an understanding of the state of a particular research subject.

[42] R Van Solingen, E Berghout. The Goal/Question/Metric Method: A Practical Guide for Quality Improvement of Software Development. (1999) [43] M Söylemez, A Tarhan.

Two well-accepted strategies that software companies can implement to preserve their competitive advantage, reducing their time to market, are Agile Software Development (ASD) and Reuse-Driven Software Engineering (RDSE) [1].

Evidence-based software engineering prospects motivated the researchers to conduct a systematic literature review. However, the topic of EDI in software engineering is not studied in detail.

TABLE 4. A rubric scale is applied for the evaluation of rigor and TABLE 4.
...
Software development and evolution is a dynamic process and is characterized by change. Software projects often begin with unclear, ambiguous, and incomplete requirements which give rise to intrinsic volatility [1].

FIGURE 6. Frequency of adapted software development standard.

Hoch et al. [23] suggests that flexibility is a good trait for SSCs that constantly change; flexibility is a crucial pillar of success.

Two well-accepted strategies that software companies can implement to preserve their competitive advantage, reducing their time to market, are Agile Software Development (ASD) and Reuse-Driven Software Engineering (RDSE) [1].

ASD relies on short feedback cycles as a way to provide flexibility and rapid adaptation to market fluctuations. In this context, decisions are also made more frequently.
...
Pellegrini et al. (P34) argue that many accessibility issues in software projects are due to (1) postponing the implementation of accessibility features by teams that adopt Agile methods (for example, because they adopt the Minimum Viable Product approach), and (2) a lack of knowledge on the implementation of accessibility.

ASD relies on short feedback cycles as a way to provide flexibility and rapid adaptation to market fluctuations. In this context, decisions are also made more frequently.

Currently, in many software development companies, teams are using various specific tools (such as Jira, GitLab and SonarQube) in order to support the development process and the quality of the code and products. This is usually done in a regular retrospective meeting that involves all the team.

The application of AI in automated code analysis has also led to significant advancements in early vulnerability detection, thereby strengthening security across SE workflows. In particular, [38] highlights the importance of machine learning (ML) and deep learning (DL) techniques in identifying security vulnerabilities and advocating for hybrid systems that enhance detection accuracy.
